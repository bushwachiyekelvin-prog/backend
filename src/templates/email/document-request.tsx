  ...
  return (
    ...
    >
      <Text style={paragraph}>
        We need some additional documents to continue processing your loan application. 
        Please upload the requested documents as soon as possible to avoid delays.
      </Text>
      ...
      <Section style={instructionsBox}>
        ...
        <Text style={instructionsText}>
          ...
          2. Navigate to your loan application<br />
          3. Click on "Upload Documents"<br />
          4. Select the requested document type<br />
      ...
      <Section style={tipsBox}>
        ...
        <Text style={tipsText}>
          ...
          • Include all pages of multi-page documents<br />
          • Make sure file size is under 10MB
        </Text>
      </Section>

      <Text style={paragraph}>
        If you have any questions about the required documents or need assistance with the upload process, 
