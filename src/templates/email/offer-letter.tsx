  ...
  return (
    ...
    >
      ...
      <Text style={paragraph}>
        Great news! We're excited to present you with a loan offer for your business. 
        After reviewing your application, we're pleased to offer you the following terms:
      </Text>
      ...
      <Section style={termsSection}>
        ...
        <Section style={termRow}>
          ...
          <Text style={termValue}>{currency} {loanAmount}</Text>
        </Section>
          ...
          <>
            ...
            {requiresGuarantor && (
              <Text style={requirementText}>
                • A guarantor is required for this loan
              </Text>
            )}
            
            {requiresCollateral && (
              <Text style={requirementText}>
                • Collateral is required for this loan
              </Text>
            )}
          </>
        )}
      ...
      <Text style={paragraph}>
        To proceed with this offer, please review and sign the complete loan agreement 
        using the secure DocuSign link below. The document contains all terms, conditions, 
      ...
      <Text style={paragraph}>
        <strong>Important:</strong> This offer expires on {formatDate(expiresAt)}. 
        Please ensure you review and sign the agreement before this date to secure your loan.
      </Text>

      <Text style={paragraph}>
        If you have any questions about the terms or need assistance with the signing process, 
        don't hesitate to reach out to our team. We're here to help you every step of the way.
      </Text>

      <Text style={paragraph}>
        Thank you for choosing Melanin Kapital for your business financing needs. 
      ...
      <Text style={disclaimer}>
        <strong>Disclaimer:</strong> This email contains sensitive financial information. 
        Please keep it secure and do not share it with unauthorized parties. 
        If you did not request this loan offer, please contact us immediately.
      </Text>
    </BaseTemplate>
  );
};
