...
export async function investorOpportunitiesRoutes(fastify) {
    ...
    fastify.post("/", {
        ...
        try {
            ...
            const result = await InvestorOpportunitiesService.create(userId, request.body);
    ...
    fastify.patch("/:id", {
        ...
        try {
            ...
            const { id } = request.params || {};
            const result = await InvestorOpportunitiesService.update(userId, id, request.body);
            return reply.send(result);
        }
        catch (error) {
