...
export const businessDocuments = pgTable("business_documents", {
    ...
    return {
        ...
        uqBusinessDocsUniquePerYear: uniqueIndex("uq_business_docs_unique_per_year").on(table.businessId, table.docType, table.docYear, table.docBankName),
        idxBusinessDocsBusinessDeleted: index("idx_business_docs_business_deleted").on(table.businessId, table.deletedAt),
        idxBusinessDocsBusinessCreated: index("idx_business_docs_business_created").on(table.businessId, table.createdAt),
    };
});
