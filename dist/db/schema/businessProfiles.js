...
export const businessProfiles = pgTable("business_profiles", {
    ...
    return {
        ...
        idxBusinessProfilesUserDeleted: index("idx_business_profiles_user_deleted").on(table.userId, table.deletedAt),
        idxBusinessProfilesUserCreated: index("idx_business_profiles_user_created").on(table.userId, table.createdAt),
    };
});
