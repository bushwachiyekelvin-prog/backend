...
export const investorOpportunities = pgTable("investor_opportunities", {
    ...
    return {
        ...
        idxInvestorOpportunitiesCountry: index("idx_investor_opportunities_country").on(table.countryOfOrigin),
        idxInvestorOpportunitiesActive: index("idx_investor_opportunities_active").on(table.isActive),
        idxInvestorOpportunitiesDeletedAt: index("idx_investor_opportunities_deleted_at").on(table.deletedAt),
        idxInvestorOpportunitiesCreatedAt: index("idx_investor_opportunities_created_at").on(table.createdAt),
    };
});
